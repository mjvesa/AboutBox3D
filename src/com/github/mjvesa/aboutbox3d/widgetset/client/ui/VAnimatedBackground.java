...
public class VAnimatedBackground extends Composite implements Paintable 
{
	...
	private native void drawObject(double x,double y) /*-{
	    ...
	    var temporalAAEnabled = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::temporalAAEnabled;
	    var edgeAAEnabled = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::edgeAAEnabled;

	    var useVML = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::useVML;

	    var previous = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::previous;

	    var texture = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::light;

	    var frameCount = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::frameCount;

   	    var textureX = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::textureX;
	    var textureY = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::textureY;
   	    
   	    var width = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::width;
	    var height = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::height;
   	    
   	    var objectZ = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::objectZ;
	    var objectScale = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::objectScale;

	    var jitters = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::jitters;

	    var faces = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::faces;
	    var vertices = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::vertices;
	    var normals = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::normals;
	    
	    var baseColor = this.@com.github.mjvesa.aboutbox3d.widgetset.client.ui.VAnimatedBackground::baseColor;
